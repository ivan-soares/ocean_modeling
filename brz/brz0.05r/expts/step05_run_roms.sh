...
#
	...
	echo; echo " ... avg flag is $avg_flag"; echo

	if    [ $avg_flag == 'avg_with_qcorr'    ]; then echo " ... will compute daily averages"
	elif  [ $avg_flag == 'avg_no_qcorr_lwrad_down' ]; then echo " ... will compute daily averages"
	elif  [ $avg_flag == 'no_avg' ]; then echo " ... will NOT compute daily averages"
	else    echo " ... ERROR, wrong avg choice, exiting "; exit 1
	fi

	roms_exec="$roms_codedir/romsMY25_brazil_${ramp_flag}_${nudge_flag}_${avg_flag}"
