...
#
	...
	appflag="BRZ"
	mytitle="Brazil ${yr} 1/20 rotated 55W-25W - 42S-0N (221x651x30)"
	varinfo="$HOME/operational/roms/code/varinfo_era5.dat"
	...
	wesn_roms="-55.0 -25.0 -42.0 0.0"
	wesn_ogcm="-55.0 -25.0 -42.0 0.0"
	wesn_gfs=" -55.0 -25.0 -42.0 0.0"
	wesn_sla=" -55.0 -25.0 -42.0 0.0"
	...
	ramp_flag='tide_no_ramp'         # either tide_with_ramp or tide_no_ramp or no_tide
	nudge_flag='nudge_by_user'  # either nudge_by_user  or ananudge
	avg_flag='avg_no_qcorr_lwrad_down'    # either avg or no_avg  or avg_no_dqdsst
	...
	if [ ! -e $stodir/$today ]; then mkdir -p $stodir/$today;fi
	...
	romsfrc="$casedir/force/d-storage/atmos_era5/force_${domain_wind}_${yr}_${wind}_03h.nc" # force file for roms
	romsclm="$casedir/clim/d-storage/input_clm_${domain_roms}_${version}_${yr}0101_${ogcm}_365d_24h.nc" # clim file for roms
	romsbry="$casedir/clim/d-storage/input_bry_${domain_roms}_${version}_${yr}0101_${ogcm}_365d_24h.nc" # bdry file for roms
