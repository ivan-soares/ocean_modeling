...
#
	...
	domain="sse0.25"
	force_file="force_${domain}_${year}_cfsr_03h.nc"
	...
	for var in q2m tmp2m wnd10m prate dlwsfc dswsfc ulwsfc uswsfc; do 
	...
	echo
        echo " ... fix cfsr file 4 roms "
        echo

	fix_cfsr4roms_new.sh cfsr_${year}.nc $force_file
