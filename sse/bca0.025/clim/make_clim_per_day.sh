...
#################### file & dir names ########################################################
	...
	ogcmdir="d-inputs/glbv_npo0.08_06h"
	ogcmdir="d-inputs/nemo_brz0.08_06h"
	tmpogcm="$ogcmdir/${ogcm}_brz_YYYYMMDD.nc"
	...
	tmpmsk="d-interp/grid_${domain}_${version}.tmpmsk"
...
################## here we start interpolating OGCM data #####################################
	...
	rm -rf grid_r.nc weights_r.nc 
        cp d-interp/grid_rho.nc grid_r.nc
