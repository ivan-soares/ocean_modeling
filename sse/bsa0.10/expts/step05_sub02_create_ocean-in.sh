...
###################### *** fix the ocean.in file *** #####################################
       ...
       sed -e "s|INPUTS|$inpdir|g" -e "s|OUTPUTS|$outdir|g" \
           $roms_codedir/roms_${domain_roms}.in >& ocean_${expt}.in
       ...
       #sed -i " / LBC(isUvel) == /c\ LBC(isUvel) ==  Rad     Rad     Rad     Rad        ! 3D U-momentum"  ocean_${expt}.in
       #sed -i " / LBC(isVvel) == /c\ LBC(isVvel) ==  Rad     Rad     Rad     Rad        ! 3D V-momentum"  ocean_${expt}.in
