...
roms1 = '/home/ivans/roms/cases/sse/bsa0.10/grid/grid_bsa0.10_01a.nc'
roms2 = '/home/ivans/roms/cases/sse/bsa0.10/grid/grid_pgua0.02_01a.nc'
...
figure
pcolor(lon1,lat1,prf1./msk1), shading flat, axis equal, colorbar, hold on, plot(lon1,lat1,'c'), plot(lon1',lat1','c')
pcolor(lon2,lat2,prf2./msk2), shading flat, axis equal, hold on, plot(lon2,lat2,'y'), plot(lon2',lat2','y')
plot(box2(:,1), box2(:,2), 'g','linewidth',2)
title('ROMS GRID BSA0.10 - Topography'), xlabel('Longitude'), ylabel('Latitude')
...
A = axis, plot(lon,lat,'w'), axis (A)
print -dpng grid_topo_bsa0.10.png
