...
#
	...
	ls -1 d-inputs/gfsanl_${domain}_${dh}/gfs_${today}* >& list_of_files
	#ls -1 ~/gfs_2020/gfs_${today}* >& list_of_files 
	#ls -a ~/transfer/gfsanl_${today}*  >& list_of_files
	#ls -1 gfsanl_glo0.50_2020_03h/gfs_${today}* >& list_of_files
