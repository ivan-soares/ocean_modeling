...
f2 = '/home/ivans/roms/cases/sse/bsa0.025/grid/grid_bsa0.025_01b.nc'
...
big_title = 'ROMS grid in Santos Basin'
small_title = 'Santos Bight topography (meters)'

# limits of grid_bca0.025_01b.nc
i1 = [-49.50, -49.50, -39.00, -39.00, -49.50]
j1 = [-22.00, -30.00, -30.00, -22.00, -22.00]
...
plt.savefig('bsantos_grid.png',dpi=100)
plt.close()
